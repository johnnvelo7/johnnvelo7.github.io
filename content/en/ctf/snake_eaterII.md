...
Now just to make a python script that can read this file REALLY fast. This is when I decided to create a python program called **PATH_WATCHER** that can do just that (shameless plug).
